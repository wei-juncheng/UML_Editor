...
public class GeneralizationLine extends MainButton {

	public GeneralizationLine(String button_name, GUI m) {
		super(button_name, m);
	...
	public void CanvasPressEvent(int x, int y, MainObject obj) {
		...
		ObjectGeneralizationLine ass_line = new ObjectGeneralizationLine(obj, nearest_port);
